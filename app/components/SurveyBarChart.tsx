...
export function SurveyBarChart({ title, items, color = "#378fe7" }: { title: string; items: ChartItem[]; color?: string }) {
  const options = useMemo<Highcharts.Options>(() => ({
    ...
    xAxis: {
      ...
      lineColor: "#dce6f0",
      tickColor: "#dce6f0",
      labels: { style: { color: "#304b65", fontSize: "14px", fontWeight: "600" } },
    },
    yAxis: {
      min: 0,
      allowDecimals: false,
      ...
      labels: { style: { color: "#60778d", fontSize: "13px", fontWeight: "600" } },
    },
    ...
    plotOptions: {
      bar: {
        ...
        dataLabels: {
          ...
          crop: false,
          overflow: "allow",
          style: { color: "#14263b", fontSize: "14px", fontWeight: "800", textOutline: "none" },
        },
      },
    },
    series: [{
